...
def recorrelaberinto(intersecciones):
   # Empezamos en la entrada
    ...
    while actual["id"] not in [10, 11] and iteraciones < MAX_ITERACIONES:
...
while(salir!=True):
    ...
    salida=str(input("Desea continuar? s/n: "))
    if(salida=="n"):
        salir=True
