...
const App = () => {
    ...
    console.log('%cjuegos.js line:23 juegoData', 'color: #007acc;', juegoData);
    const iframeProps = {
        ...
        React.createElement('div', {className: 'father'},
            ...
            React.createElement('div', {className: 'wrap'},
                React.createElement('div', {className: 'left'},
                    React.createElement('img', {className: 'imagen', src: juegoData.src, alt: 'Imagen del Juego' }) //mmg voy a por algo de cena
                ),
